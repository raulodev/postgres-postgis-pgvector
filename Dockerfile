...
COPY --from=builder /usr/lib/postgresql17/vector.so /usr/lib/postgresql17/
COPY --from=builder /usr/share/postgresql17/extension/vector* /usr/share/postgresql17/extension/
